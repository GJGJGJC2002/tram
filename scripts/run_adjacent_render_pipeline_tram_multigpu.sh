...
# Adjacent Frame SMPL Rendering - 多 GPU 并行
# 将序列均分到多张 GPU 上同时运行
# 使用示例：bash scripts/run_adjacent_render_pipeline_tram_multigpu.sh
# 自定义 GPU：GPU_IDS="0,1,2" bash scripts/run_adjacent_render_pipeline_tram_multigpu.sh
